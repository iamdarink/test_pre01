...
export default function Footer() {
        ...
        },
        {
            ...
            description: [
                ...
                <button className="flex items-center gap-3 px-3 py-1 bg-white text-[#424242] rounded-full">
                    <img src="/footer/Location.svg" alt="Location icon" className="w-4 h-4" />
                    Map
                </button>
            ],
        },
    ...
    return (
        <>
            ...
            <div className="flex w-full h-auto bg-[#212121] justify-center text-center text-white p-[10px] sm:text-[14px] lg:text-[16px] ">
                © 2020 All Rights Reserved by Coding Hub Company Limited.
            </div>
