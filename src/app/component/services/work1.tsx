            ...
            <div >
                <div className="container mx-auto px-14 w-full]">
                    <div className="flex mt-10 ">
                        <div className="w-full h-[250px] justify-center lg:justify-start items-center inline-flex">
                            <TextField
                                number="01"
                            ...
                            />
                            <div className="hidden lg:flex w-[50px] h-[15px] bg-lime-600 "></div>
                            <TextField
                                number="02"
                            ...
                            />
                            <div className="hidden lg:flex w-[150px] h-[15px] bg-lime-600 rounded-tr-[20px]"></div>
                            <div className="hidden lg:flex w-[180px] h-[15px] origin-top-left rotate-90 bg-lime-600 rounded-tl-[20px]"></div>
                        </div>
                    </div>
                    <div className="flex mt-10">
                        <div className="w-full h-[250px] justify-center lg:justify-end items-center inline-flex">
                            <div>
                                <p className="hidden lg:flex w-[150px] h-[15px] origin-bottom-left rotate-90 bg-lime-600 rounded-bl-[20px]"></p>
                                <p className="hidden lg:flex w-[170px] h-[15px] bg-lime-600 rounded-tl-[20px]"></p>
                            </div>
                            <TextField
                                number="04"
